...
#if defined (TAOX11_AS_STATIC_LIBS) && !defined (DANCEX11_NODE_DH_HAS_DLL)
#  define DANCEX11_NODE_DH_HAS_DLL 0
#endif /* TAOX11_AS_STATIC_LIBS && DANCEX11_NODE_DH_HAS_DLL */
...
#    define DANCEX11_NODE_DH_Export TAOX11_Proper_Export_Flag
#    define DANCEX11_NODE_DH_SINGLETON_DECLARATION(T) TAOX11_EXPORT_SINGLETON_DECLARATION (T)
#    define DANCEX11_NODE_DH_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) TAOX11_EXPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
#  else /* DANCEX11_NODE_DH_BUILD_DLL */
#    define DANCEX11_NODE_DH_Export TAOX11_Proper_Import_Flag
#    define DANCEX11_NODE_DH_SINGLETON_DECLARATION(T) TAOX11_IMPORT_SINGLETON_DECLARATION (T)
#    define DANCEX11_NODE_DH_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) TAOX11_IMPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
