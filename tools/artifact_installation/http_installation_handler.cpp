// -*- C++ -*-
/**
 * @file http_installation_handler.cpp
...
namespace DAnCEX11
{
  ...
  ArtifactInstallationHandler* HttpInstallationHandlerSvc::handler_instance ()
    {
      return HttpInstallationHandler::getInstance ();
    }

  int HttpInstallationHandlerSvc::Initializer ()
  {
  ...
  const std::string& HttpInstallationHandler::protocol_prefix ()
    {
