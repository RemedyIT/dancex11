...
#ifndef DANCEX11_CONFIG_HANDLERS_DYNSTRUCT_HANDLER_H
#define DANCEX11_CONFIG_HANDLERS_DYNSTRUCT_HANDLER_H
...
namespace DAnCEX11
{
  namespace Config_Handlers
  {
    ...
    {
    public:
      static IDL::traits<DynamicAny::DynAny>::ref_type extract_into_dynany (const DataType &type,
...
#endif /* DANCEX11_CONFIG_HANDLERS_DYNSTRUCT_HANDLER_H*/
