...
#DANCEX11_LOG_MASK should overwrite X11_LOG_MASK
$log_test->SetEnv ("DANCEX11_LOG_MASK", "INFO|WARNING");
...
#DANCEX11_VERBOSE should overwrite X11_VERBOSE
$log_test->SetEnv ("DANCEX11_VERBOSE", "CATEGORY|PRIO");
